...
export default function SantaRPS({ partnerId, isSanta, onGameComplete }: SantaRPSProps) {
    // Unused: partnerId, isSanta (Game is vs CPU for now)
    console.log("RPS vs CPU. Context:", partnerId, isSanta);
    ...
    const playMove = (move: Move) => {
        ...
        setTimeout(() => {
            ...
            // Whether win or lose, we mark it completed to limit daily play
            api.completeRPS(win).then(() => {
