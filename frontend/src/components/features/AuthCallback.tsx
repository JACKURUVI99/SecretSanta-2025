    ...
    useEffect(() => {
        ...
        const handleCallback = async () => {
            try {
                ...
                const tokenResponse = await fetch(`${baseUrl}/api/dauth/oauth/token`, {
                    method: 'POST',
                    headers: {
                ...
                if (!userData) {
                    ...
                    const baseUrl = import.meta.env.VITE_API_BASE_URL || '';
                    const userResponse = await fetch(`${baseUrl}/api/dauth/resources/user`, {
                        headers: {
                ...
                // Extract roll number from email - Done inline now

                /* RESTRICTION REMOVED for Universal Access
