        ...
        <div className="fixed bottom-4 left-4 z-[100] font-mono">
            ...
            {!isOpen && (
                <button
                    ...
                    className="fixed bottom-6 left-6 z-[99] bg-[#C41E3A] text-white p-4 border-4 border-black shadow-[6px_6px_0px_0px_black] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_black] transition-all rounded-full group"
                >
