...
export default function ChristmasBackground() {
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 bg-[#C41E3A]">
            ...
            <div className="absolute inset-0 animate-spin-slow-bg opacity-20"
                style={{
                    background: 'repeating-conic-gradient(from 0deg, #990f24 0deg 15deg, transparent 15deg 30deg)',
                    transformOrigin: '50% 50%',
                    scale: '2' // Ensure coverage during rotation
                }}
            ></div>

            {/* Base Red Color */}
            <div className="absolute inset-0 bg-[#C41E3A] -z-10"></div>
