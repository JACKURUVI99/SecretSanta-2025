...
DROP POLICY IF EXISTS "profiles_insert_own_v3" ON public.profiles;
DROP POLICY IF EXISTS "profiles_update_v3" ON public.profiles;
DROP POLICY IF EXISTS "profiles_read_all_v4" ON public.profiles;
DROP POLICY IF EXISTS "profiles_insert_own_v4" ON public.profiles;
...
CREATE POLICY "profiles_read_all_v4"
ON public.profiles FOR SELECT
USING (true);
CREATE POLICY "profiles_insert_own_v4"
